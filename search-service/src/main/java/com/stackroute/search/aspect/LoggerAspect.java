package com.stackroute.search.aspect;
...
public class LoggerAspect {
    ...
    @Pointcut("execution (* com.stackroute.search.controller.ProjectController.*(..)) || " +
            "execution (* com.stackroute.search.controller.UserProfileController.*(..))")
