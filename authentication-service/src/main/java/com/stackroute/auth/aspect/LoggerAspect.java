package com.stackroute.auth.aspect;
...
public class LoggerAspect {
    ...
    @Pointcut("execution (* com.stackroute.auth.controller.OTPController.*(..)) || " +
            "execution (* com.stackroute.auth.controller.UserAuthenticationController.*(..))")
