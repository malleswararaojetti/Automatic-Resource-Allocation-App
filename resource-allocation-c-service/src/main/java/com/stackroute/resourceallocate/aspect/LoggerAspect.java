package com.stackroute.resourceallocate.aspect;
...
public class LoggerAspect {
    ...
    @Pointcut("execution (* com.stackroute.resourceallocate.controller.ProjectController.*(..)) || " +
            "execution (* com.stackroute.resourceallocate.controller.QueryController.*(..)) || " +
            "execution (* com.stackroute.resourceallocate.controller.UserProfileController.*(..))")
